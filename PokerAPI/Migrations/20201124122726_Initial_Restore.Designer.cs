...
namespace PokerAPI.Migrations
{
    ...
    [Migration("20201124122726_Initial_Restore")]
    partial class Initial_Restore
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelService.GameLogModels.UserLogModel", b =>
                {
                    b.Property<int>("UserLogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ModelService.UserBan", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ModelService.Ban", b =>
                {
                    b.HasOne("ModelService.ApplicationUser", "Reporter")
                        .WithMany()
            ...
            modelBuilder.Entity("ModelService.GameLogModels.RoundUserLog", b =>
                {
                    ...
                    b.HasOne("ModelService.GameLogModels.UserLogModel", "UserLog")
                        .WithMany("RoundUserLog")
